 ...
 */
Eigen::Matrix<double,3,3> StandardModel_susy_parameters::calc_beta_Yd_one_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Yd = 0.25*oneOver16PiSqr*(-(Yd*(-12*traceYdAdjYd - 4*traceYeAdjYe
      ...
      Yd.adjoint()*Yd - Yd*Yu.adjoint()*Yu));
 ...
 */
Eigen::Matrix<double,3,3> StandardModel_susy_parameters::calc_beta_Yd_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
