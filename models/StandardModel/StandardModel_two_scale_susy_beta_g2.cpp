 ...
 */
double StandardModel_susy_parameters::calc_beta_g2_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double StandardModel_susy_parameters::calc_beta_g2_two_loop(const Susy_traces& susy_traces) const
{
