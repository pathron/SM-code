...
#ifndef StandardModel_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define StandardModel_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "StandardModel_low_scale_constraint.hpp"
...
template<>
class StandardModel_low_scale_constraint<Two_scale> : public Constraint<Two_scale> {
public:
   StandardModel_low_scale_constraint();
   StandardModel_low_scale_constraint(const StandardModel_input_parameters&, const QedQcd&);
   virtual ~StandardModel_low_scale_constraint();
   virtual void apply();
