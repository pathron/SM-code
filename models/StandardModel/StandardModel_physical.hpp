...
#ifndef StandardModel_PHYSICAL_H
#define StandardModel_PHYSICAL_H
...
struct StandardModel_physical {
   StandardModel_physical();
   void clear();
...
std::ostream& operator<<(std::ostream&, const StandardModel_physical&);
