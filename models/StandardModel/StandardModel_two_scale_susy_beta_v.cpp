 ...
 */
double StandardModel_susy_parameters::calc_beta_v_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double StandardModel_susy_parameters::calc_beta_v_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
