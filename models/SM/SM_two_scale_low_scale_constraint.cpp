...
SM_low_scale_constraint<Two_scale>::SM_low_scale_constraint(const SM_input_parameters& inputPars_, const QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(0)
...
{
   assert(model && "Error: SM_low_scale_constraint:"
