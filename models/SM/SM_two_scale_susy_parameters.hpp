...
// File generated at Fri 22 Aug 2014 11:56:03
...
public:
   ...
   SM_susy_parameters(double scale_, double loops_, double thresholds_, const SM_input_parameters& input_, double Lambdax_, const Eigen::Matrix<double,3,3>& Yu_, const Eigen::Matrix
