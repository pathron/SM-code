...
StandardModel_initial_guesser<Two_scale>::StandardModel_initial_guesser(
   StandardModel<Two_scale>* model_,
   const StandardModel_input_parameters& input_pars_,
   const QedQcd& oneset_,
   const StandardModel_low_scale_constraint<Two_scale>& low_constraint_,
   const StandardModel_susy_scale_constraint<Two_scale>& susy_constraint_
)
...
{
   assert(model && "StandardModel_initial_guesser: Error: pointer to model"
          " StandardModel<Two_scale> must not be zero");
}
 ...
 */
void StandardModel_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void StandardModel_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void StandardModel_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
 ...
 * corrections).
 */
void StandardModel_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void StandardModel_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void StandardModel_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void StandardModel_initial_guesser<Two_scale>::guess_soft_parameters()
{
